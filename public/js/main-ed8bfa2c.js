...
},{"./lib/halftone":1,"./modules/manifesto":3,"./modules/smoothscroll":4,"./modules/stickyscroll":5,"./modules/tge":6}],3:[function(require,module,exports){
module.exports = function () {

  $(document).ready(function() {

    var img = document.querySelector('.ht-img-horz');

    $('.ht-img-horz').width($(window).width());
