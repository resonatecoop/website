...
<img loading="lazy" decoding="async" class="aligncenter wp-image-2693 size-full" src="https://resonate.is/wp-content/uploads/2015/12/stream-cost-large.png" width="400" height="400" srcset="http://resonate.localhost/wp-content/uploads/2015/12/stream-cost-large.png 400w, http://resonate.localhost/wp-content/uploads/2015/12/stream-cost-large-200x200.png 200w, http://resonate.localhost/wp-content/uploads/2015/12/stream-cost-large-300x300.png 300w" sizes="(max-width: 400px) 100vw, 400px" /> 

** **

We start at .002 credits. The **first stream of a new song** is super cheap. _  
_ 
...
[<img loading="lazy" decoding="async" class="aligncenter wp-image-3448 size-large" src="https://resonate.is/wp-content/uploads/2015/12/stream-to-own-explained-1024x536.png" width="1024" height="536" srcset="http://resonate.localhost/wp-content/uploads/2015/12/stream-to-own-explained-1024x536.png 1024w, http://resonate.localhost/wp-content/uploads/2015/12/stream-to-own-explained-300x157.png 300w, http://resonate.localhost/wp-content/uploads/2015/12/stream-to-own-explained-768x402.png 768w, http://resonate.localhost/wp-content/uploads/2015/12/stream-to-own-explained.png 1200w" sizes="(max-width: 1024px) 100vw, 1024px" />][2]

** **

### Nine plays, not 150

By example, Spotify states that their highest potential per-stream rate is $.0084. If we divide the cost of an iTunes download (after Apple takes their cut) by that stream rate, we get 107.
...
Personally I think _Kind of Blue_ is the only album that I&#8217;ve listened to a minimum of five times a year for the last 30 years.

We think that&#8217;s not sustainable and there&#8217;s an alternative:

[raw\_html\_snippet id=&#8221;calculator&#8221;]
